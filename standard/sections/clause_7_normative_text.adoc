...
The centre identifier (``centre-id``) is an acronym as specified by the WIS Center and endorsed by WMO Secretariat.  It is a single identifier comprised of a top-level domain (TLD) and centre name. It represents the data publisher, distributor or issuing centre of a given dataset, data product, data granule or other resource.
