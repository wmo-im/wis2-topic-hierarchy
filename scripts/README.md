...
This will create/update all resources on the WMO Codes Registry. To only create/update a subset of all resources, e.g. only centre ids, then specify this the subdirectory when running the script. e.g. 
