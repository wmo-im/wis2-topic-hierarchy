...
//copied from abstract (not edited yet)
***
...
//change .."and services" to "..and services"?
The primary topics apply to all data and services in WIS.  They are relational, meaning that any combination of the values in each level can be used to construct a topic applicable to a data or metadata notification
...
.WTH example of level 8 sub-discipline topics
|===
...
The primary levels and sub-discipline specific levels are managed differently to maintain stability in the primary levels and flexibility for the sub-disciplines.
